...
% Plot for WPGMA:
clc; close all;
channel_list = {'AFZ','FP1','FP2','AF3','AF4','F7','F3','FZ','F4',...
    'F8','FC5','FC1','FC2','FC6','T7','C3','CZ',...
    'C4','T8','CP5','CP1','CP2','CP6','P7','P3','PZ',...
    'P4','P8','PO3','PO4','O1','O2','FT10','AF7','AF8','F5',...
    'F1','F2','F6','FT7','FC3','FCZ','FC4','FT8','C5','C1',....
...
figure
Values1 = clusterNum_w*ones(1,63)-cluster_w;
H1 = plot_topography(channel_list, Values1, 0, '10-20', 1, 1, 1000);
title('WPGMA');
%%
%%%%%%%%%%%%5از اینجا به بعد کد ها اجرا نمیشوند
% Plot for UPGMA:
clc;
tic
cluster_u = CorrelationCluster(cor, 0.28, 63, 'UPGMA');
...
figure
Values2 = clusterNum_w*ones(1,63)-cluster_w;
H2 = plot_topography(channel_list, Values2, 0, '10-20', 1, 1, 1000);
title('UPGMA');
%%
% Clustering for 8 channels:
clc; close all; clear all;
